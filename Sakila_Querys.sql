...
AND payment.payment_date >= '2005-08-01' AND payment.payment_date < '2005-09-01'
...
SELECT film.title FROM film JOIN language ON film.language_id = language.language_id
